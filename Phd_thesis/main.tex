...
\definecolor{TrajectoryBlue}{RGB}{52,133,198}
...
\label{partI:intro}
 ...
 \input{Phd_thesis/chapters/1.Introduction/7-summary}
...
\part*{Part II: Marine Robotics Simulator}
 %\addcontentsline{toc}{part}{Part II: Data Availability and Model Adaptability in Underwater Robotics}
 \label{partII:paper}



\chapter{UNav-Sim: A Visually Realistic Underwater Robotics Simulator and Synthetic Data-Generation Framework}
...
\part*{Part III: Coverage Path Planning}
...
This paper is to be submitted to the \textbf{IEEE Robotics and Automation Letters (RA-L)}.
...
\part*{Part IV: Data-Driven Modeling}

\chapter{Modeling of Underwater Vehicles using
...
\part*{Part V: Concluding Remarks}
%conclusion
...
\bibliographystyle{unsrt}  % Choose ONE style only
