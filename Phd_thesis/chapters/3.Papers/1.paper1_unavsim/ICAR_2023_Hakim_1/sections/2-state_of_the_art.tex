...
While progress in robotics simulation tools has been rapid, underwater robotics simulation tools have lagged behind. UWSim \cite{uwsim} and UUV Simulator \cite{uuv} are the two most commonly used underwater simulators \cite{survey}; however, they are now discontinued. %\HAK{What does this mean? not supported by the developers? or not supported by the new versions of operating systems? can you please write your claim clearer?}
