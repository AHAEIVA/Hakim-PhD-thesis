...
\addcontentsline{toc}{chapter}{Paper I: UNav-Sim}
\vspace{1cm}
...
%\includepdf[pages=-,pagecommand={},width=\textwidth]%{chapters/3.Papers/1.paper1_unavsim/ICAR_2023_Hakim_1/ICAR_2023_Hakim.pdf}


\chapter*{Paper II: REACT: Real-time Entanglement-Aware Coverage
Path Planning for Tethered Underwater Vehicles}
\addcontentsline{toc}{chapter}{Paper II: Visual Tracking Nonlinear Model Predictive Control Method for Autonomous Wind Turbine Inspection}
\vspace{1cm}
...
\addcontentsline{toc}{chapter}{Paper II: VTNMPC}
\vspace{1cm}
This paper was published at the \textbf{International Conference on Advanced Robotics (ICAR), 2023}.
...
\addcontentsline{toc}{chapter}{Paper III:  PINNS}
\vspace{1cm}
...
%\includepdf[pages=-,pagecommand={},width=\textwidth]{chapters/3.Papers/3.paper3_pinc/pinc.pdf}
...
\addcontentsline{toc}{chapter}{Paper III: DFGP}
\vspace{1cm}
...
%\includepdf[pages=-,pagecommand={},width=\textwidth]{chapters/3.Papers/4.paper4_dfgp/dfgp.pdf}




% \input{chapters/2.Data_Simulator/RelatedWorks}
% \input{chapters/2.Data_Simulator/DatasetMetrics}
% \input{chapters/2.Data_Simulator/paper2} \cleardoublepage  % MIMIR%%
% % % \input{chapters/2.Data_Simulator/paper5} \cleardoublepage  % UNAVSim

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% \part*{Part III: Optimal Control for Coverage Path Planning }
% \addcontentsline{toc}{part}{Part III: Architectures for Learning-based Localization}
% \label{partIII:architectures}

% \input{chapters/3.Architectures/Intro}
% \label{chapter:3:architectures:intro}
% \input{chapters/3.Architectures/geometry}
% \label{chapter:3:architectures:geometry}
% \input{chapters/3.Architectures/groups}
% \label{chapter:3:architectures:groups}

% \input{chapters/3.Architectures/paper3} 
% \cleardoublepage  % Loss it right
% \label{chapter:3:architectures:lossright}

% \input{chapters/3.Architectures/paper7} \cleardoublepage  % Regress right
% \label{chapter:3:architectures:regressright}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%\part*{Part IV: Data-Driven Modelling}
%\addcontentsline{toc}{part}{Part IV: Applications and Alternative Vision Paradigms}
%\label{partiv:applications}

%\input{chapters/4.Other/Intro}
%\input{chapters/4.Other/paper6} \cleardoublepage  % BT
%\input{chapters/4.Other/paper8} % Event

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%part*{Part V: Final Remarks}
%\addcontentsline{toc}{part}{Part V: Final Remarks}
%\label{partv:final}
...
% \input{chapters/epilogue} \cleardoublepage
