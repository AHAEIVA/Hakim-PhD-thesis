...
\begin{remark} The development set used in all experiments is generated independently and distinct from the training data. \end{remark}
...
%%%%%%%%%%%%%%%%
\begin{figure}[H]
    \input{Phd_thesis/chapters/3.Papers/3.paper3_pinc/IJCNN_2025/figs/pgfplots/architecture_subtables}%
...
%%%%%%%%%%%%%%%%
\begin{figure}[!t]
\input{Phd_thesis/chapters/3.Papers/3.paper3_pinc/IJCNN_2025/figs/pgfplots/rollout_exp}
     %\setcounter{figure}{3}       
...
\begin{figure}[!t]
    \centering
   \input{Phd_thesis/chapters/3.Papers/3.paper3_pinc/IJCNN_2025/figs/pgfplots/noise_expirement}
     %\setcounter{figure}{3}       
...
%%%%%%%%%%%%%%%%
\begin{figure}[t]
\input{Phd_thesis/chapters/3.Papers/3.paper3_pinc/IJCNN_2025/figs/pgfplots/best_model_subtable}
     %\setcounter{figure}{3}       
...
\input{Phd_thesis/chapters/3.Papers/3.paper3_pinc/IJCNN_2025/figs/pgfplots/trajectory_plot}
